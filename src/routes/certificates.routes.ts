...
import type { CertificateResponse, CertificateResponseWithMarkdown } from '../services/certificate.service';
...
export const certificateRoutes = new Elysia({ prefix: '/api/certificates' })
  ...
  .post('/', async ({ body, set }) => {
    ...
    body: t.Object({
      directoryPath: t.Optional(t.String({
        minLength: 1,
      ...
      authenticatorToken: t.Optional(t.String({
        minLength: 32,
  ...
  .patch('/:id', async ({ params, body, set }) => {
    ...
    body: t.Object({
      ...
      permissions: t.Optional(t.Array(t.Union([
        t.Literal('sftp'),
        t.Literal('ssh'),
        t.Literal('read-only'),
